...
(function(window, angular, undefined) {
  ...
  angular.module('satellizer', [])
    .constant('satellizer.config', {
      ...
      tokenRoot: false,
      tokenName: 'token',
      tokenPrefix: 'schnucksSocialLoginToken',
      unlinkUrl: '/auth/logout',
      unlinkMethod: 'get',
      ...
      providers: {
        google: {
          ...
          redirectUri: window.location.origin + '/login' || window.location.protocol + '//' + window.location.host + '/login',
          scope: ['profile', 'email'],
          scopePrefix: 'openid',
          scopeDelimiter: ' ',
        ...
        facebook: {
          ...
          scope: ['email'],
          scopeDelimiter: ',',
          requiredUrlParams: ['display', 'scope', 'response_type'],
          responseType: 'token',
          display: 'page',
          type: '2.0',
